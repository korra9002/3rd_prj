...
<form class="card" id="cardInfoFrm" action="finish_signUp.do" method="post" style="width: 550px; height: 500px; padding-top: 20px ; margin-left: auto; margin-right: auto;">
		...
		<div><img src="http://localhost:8080/3rd_pprj/kr.co.sist.user.view/images/credit-card3.png">&nbsp;&nbsp;&nbsp;&nbsp;<strong>결제정보 입력</strong></div><br/>
			...
			<table>
				...
				<tr>
					<td>카드유형</td>
					<td>
			      <select class="form-control" name="cardTypeCode" style="width: 100px">
						<option value="01"><c:out value="visa"/>visa</option>
						<option value="02"><c:out value="master"/>master</option>
						<option value="03"><c:out value="adas"/>adas</option>
						<option value="04"><c:out value="visa"/>visa</option>
				  </select></td>
				</tr>
				<tr>
					<td>만료일</td>
				...
				<button type="button" class="btn btn-secondary alert-secondary btn" id="nextBtn">다음에 하기</button>
				</div>
	</div>
</form>	 
 </div>
